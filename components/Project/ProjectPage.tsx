...
export const ProjectPage = ({ data }) => {
  ...
  const img = urlFor(image.src).auto('format').width(800).height(800).dpr(2).quality(90).url();
        ...
        <Layout>
          ...
          >
            ...
            {images && images.map((image, index) => {
              const img = urlFor(image).auto('format').width(800).height(800).dpr(2).quality(90).url();
